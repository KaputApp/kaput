...
//  KAPUT
//
//  Created by KAPUT on 28/07/2016.
...
public class KaputStyle : NSObject {
    ...
    public class func drawNumberOfNotifications() {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
    ...
    public class func drawBigNotif(batteryLevelLenght batteryLevelLenght: CGFloat = 88.1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(rect: CGRect(x: 0.3, y: 12.82, width: 330.8, height: 96.15))
        strokeColor2.setStroke()
        rectanglePath.lineWidth = 10
        rectanglePath.stroke()
        ...
        //// Rectangle 3 Drawing
        let rectangle3Path = UIBezierPath(rect: CGRect(x: 0.3, y: 12.82, width: 330.8, height: 96.15))
        fillColor2.setFill()
        rectangle3Path.fill()
        ...
        //// Rectangle 4 Drawing
        let rectangle4Path = UIBezierPath(rect: CGRect(x: 0.3, y: 12.82, width: 330.8, height: 96.15))
        strokeColor2.setStroke()
        rectangle4Path.lineWidth = 10
        rectangle4Path.stroke()
        ...
        //// Rectangle 6 Drawing
        let rectangle6Path = UIBezierPath(rect: CGRect(x: 7.2, y: 19.6, width: batteryLevelLenght, height: 82.6))
        fillColor3.setFill()
        rectangle6Path.fill()


        //// Rectangle 8 Drawing
        let rectangle8Path = UIBezierPath(rect: CGRect(x: 328.8, y: 49.4, width: 10.3, height: 25.2))
        fillColor.setFill()
        rectangle8Path.fill()
        ...
        //// Rectangle 9 Drawing
        let rectangle9Path = UIBezierPath(rect: CGRect(x: 125, y: 0, width: 92, height: 27))
        fillColor5.setFill()
        rectangle9Path.fill()
    }
    ...
    public class func drawLaunchViewBolt() {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
