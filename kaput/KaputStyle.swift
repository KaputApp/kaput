...
//  KAPUT
//
//  Created by KAPUT on 06/06/2016.
...
public class KaputStyle : NSObject {
    ...
    public class func drawBatteryNotificationCanvas() {
        ...
        //// path-1 Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 167.65, 63.9)
        CGContextRotateCTM(context, -3 * CGFloat(M_PI) / 180)
        ...
        //// level Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 53.35, 69.9)
        CGContextRotateCTM(context, -3 * CGFloat(M_PI) / 180)
        ...
        //// Label Drawing
        let labelRect = CGRect(x: 30.73, y: 35.23, width: 304.1, height: 69)
        ...
        //// batteryCap Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 335.75, 56.25)
        CGContextRotateCTM(context, -3 * CGFloat(M_PI) / 180)
        ...
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 170.45, 16.35)
        CGContextRotateCTM(context, -3 * CGFloat(M_PI) / 180)
        ...
        //// Label 2 Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 129.09, 5.74)
        CGContextRotateCTM(context, -3 * CGFloat(M_PI) / 180)
