...
//  KAPUT
//
//  Created by KAPUT on 01/08/2016.
...
public class KaputStyle : NSObject {
    ...
    public class func drawBigNotif(frame frame: CGRect = CGRect(x: 0, y: 0, width: 359, height: 119), notifColor: UIColor = UIColor(red: 1.000, green: 0.216, blue: 0.380, alpha: 1.000), batteryLevelLenght: CGFloat = 88.1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
