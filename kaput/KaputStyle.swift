...
//  KAPUT
//
//  Created by KAPUT on 27/05/2016.
...
public class KaputStyle : NSObject {
    ...
    public class func drawBatteryNotificationCanvas(notificationBatteryLevelWidth notificationBatteryLevelWidth: CGFloat = 71.09598) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// level Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 37.37, 70.79)
        CGContextRotateCTM(context, -3 * CGFloat(M_PI) / 180)

        let levelPath = UIBezierPath(rect: CGRect(x: -27.05, y: -41.3, width: notificationBatteryLevelWidth, height: 82.6))
        KaputStyle.lowRed.setFill()
        levelPath.fill()
        ...
        //// Label Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 15.73, 38.23)
        CGContextRotateCTM(context, -3 * CGFloat(M_PI) / 180)

        let labelRect = CGRect(x: 0, y: 0, width: 304.1, height: 69)
    ...
    public class func drawBackArrow() {
        ...
        fill26Path.moveToPoint(CGPoint(x: 14.79, y: 29.49))
        fill26Path.addLineToPoint(CGPoint(x: 0.05, y: 15))
        fill26Path.addLineToPoint(CGPoint(x: 14.79, y: 0.51))
        fill26Path.addLineToPoint(CGPoint(x: 16.79, y: 2.49))
        fill26Path.addLineToPoint(CGPoint(x: 4.06, y: 15))
        fill26Path.addLineToPoint(CGPoint(x: 16.79, y: 27.51))
        fill26Path.addLineToPoint(CGPoint(x: 14.79, y: 29.49))
        ...
        //// Fill-27 Drawing
        let fill27Path = UIBezierPath(rect: CGRect(x: 2.07, y: 13.5, width: 25.95, height: 3))
        fillColor4.setFill()
        fill27Path.fill()
    }
